            ...
            foreach ($products as $product){
                ...
                echo '<tr>';
                    ...
                    echo '<td class="toolbox text-center">';
                        echo '<a href="/pages/products/edit/'.$product->id.'" class="text-decoration-none" title="Edit"><i class="fas fa-edit fa-lg pr-1"></i></a>';
                        echo '<a href="/pages/products/view/'.$product->id.'" class="text-decoration-none" title="View"><i class="fas fa-eye fa-lg pr-1"></i></a>';
                        echo '<a href="/pages/products/delete/'.$product->id.'" class="text-decoration-none" title="Delete"><i class="fas fa-trash-alt fa-lg text-danger"></i></a>';
                    echo '</td>';
                echo '</tr>';
            }
        ?>
